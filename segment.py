...
#NOTE: Possibly change to /home/ray/BDD/bdd100k/ if doesn't work. Won't ship though.
...
# [
    ...
    VALID = Path('{}/images/10k/val'.format(ROOT_DIR))
    vld = sorted(glob(os.path.join(VALID, "*.jpg")))
